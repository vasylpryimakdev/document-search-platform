...
export function UploadPanel() {
  ...
  return (
    ...
    >
      <div>
        <h2 className="mb-2 text-[28px] font-semibold" id="documents-title">Your documents</h2>
        <p className="m-0 text-slate-300">Upload one PDF or DOCX file under 10MB. New uploads appear as pending.</p>
      </div>
      <input
        ref={fileInputRef}
        className="hidden"
      ...
      />
      <Button className="min-w-24" type="button" disabled={isUploading} onClick={() => fileInputRef.current?.click()}>
